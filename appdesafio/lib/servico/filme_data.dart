...
class FilmesData {
  ...
  late final  List<ResultsInFilms> ? results;
  
  FilmesData.fromJson(Map<String, dynamic> json){
    count = json['count'];
    next = null;
    previous = null;
    results = List.from(json['results']).map((e)=>ResultsInFilms.fromJson(e)).toList();
  }
